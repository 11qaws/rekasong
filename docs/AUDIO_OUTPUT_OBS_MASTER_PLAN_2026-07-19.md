...
- 10분 상대 drift는 10ms 이내, marker interval/offset jitter p95는 5ms 이하다.
...
11. **카라오케 싱크 인증**
    mic/MR 분리 track과 실제 monitor path를 10분 측정하고 짧은 재검을 한 번 더 한다.
