...
>
> 최신 공개 배포와 로컬 검증 기준은 v0.2.22다. 실제 OBS·로컬 녹화·OBS→Speaker 전환 물리 증거는 [OBS_PHYSICAL_VALIDATION_2026-07-22.md](./OBS_PHYSICAL_VALIDATION_2026-07-22.md)와 [OBS_MANUAL_ACCEPTANCE_RUNBOOK_2026-07-19.md](./OBS_MANUAL_ACCEPTANCE_RUNBOOK_2026-07-19.md)에 보존한다.
...
- OBS 정적 경로: 383,782B raw / 117,551B gzip / 102,979B brotli.
- OBS 예산: 460,800B raw / 133,120B gzip 이내 통과.
- Worker 문법 검사와 `git diff --check` 통과.

## 7. 배포 완료와 다음 관문

1. Worker `9dd91fc4-81e1-45a8-9d15-e7250e4a3496`와 frontend `0.2.22` / `c307e2007675e3dbb3b1ded09f62566546422670` 배포를 완료했다. 앱 배포 workflow `29959351699`는 성공했다.
2. GitHub Pages clean install·715개 테스트·build·OBS budget·publish, production recovery smoke, ntfy 요청 0·HTTP 오류 0, 모바일 viewport의 hairpin·유레카 금발 선을 확인했다.
